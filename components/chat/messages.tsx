...
function EmptyMessages() {
  return (
    <div 
      className="absolute top-19 left-1/2 -translate-x-1/2 px-6 py-3 bg-[#080808] border-4 border-[#333] text-[#33ff33] font-['OCR-A',_monospace] text-lg rounded-lg shadow-lg whitespace-nowrap overflow-hidden"
      style={{
