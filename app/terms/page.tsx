      ...
      <div className="w-full max-w-screen-md space-y-6">
        ...
        <ol className="list-decimal list-inside space-y-4">
          ...
          <li className="text-gray-700">
            ...
            or implied. Daniel Osika makes no representations or warranties regarding
          ...
          <li className="text-gray-700">
            ...
            Daniel Osika does not guarantee that the Chatbot will be available at all
          ...
          <li className="text-gray-700">
            ...
            the fullest extent permitted by applicable law, Daniel Osika shall not be
            ...
            Daniel Osika has been advised of the possibility of such damages.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">
              No Legal, Financial, or Professional Advice:
            </span>{" "}
            The Chatbot is intended for informational, entertainment, and general purposes only.
          ...
          <li className="text-gray-700">
            ...
            decisions made based on its output. Daniel Osika is not responsible for any
          ...
          <li className="text-gray-700">
            ...
            considered equivalent to public postings, and Daniel Osika does not
          ...
          <li className="text-gray-700">
            ...
            indemnify, defend, and hold harmless Daniel Osika from any claims,
            liabilities, damages, losses, and expenses, including reasonable
            legal fees, arising from your use of the Chatbot or violation of
            these Terms of Use.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">Modifications to Terms:</span> Daniel Osika
          ...
          <li className="text-gray-700">
            ...
            contact Daniel Osika at daniel.j.osika@gmail.com.
          </li>
        </ol>
      </div>
    </div>
